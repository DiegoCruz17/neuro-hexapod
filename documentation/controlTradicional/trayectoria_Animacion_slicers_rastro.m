...
% Slider d
slider_d = uicontrol('Style','slider','Min',0,'Max',100,'Value',d,...
...
% Slider w
slider_w = uicontrol('Style','slider','Min',-1,'Max',1,'Value',w,...
...
% Slider ra
slider_ra = uicontrol('Style','slider','Min',0,'Max',1,'Value',ra,...
...
for k = k_total
    ...
    % Actualizar rastro
    rastro_P1 = [rastro_P1, P1];
    rastro_P2 = [rastro_P2, P2];
    rastro_P3 = [rastro_P3, P3];
    rastro_P4 = [rastro_P4, P4];
    rastro_P5 = [rastro_P5, P5];
    rastro_P6 = [rastro_P6, P6];

    % Limpiar figura
    cla

    % Dibujar rastro en gris
    plot3(rastro_P1(1,:), rastro_P1(2,:), rastro_P1(3,:), 'Color', [0.5 0.5 0.5])
    plot3(rastro_P2(1,:), rastro_P2(2,:), rastro_P2(3,:), 'Color', [0.5 0.5 0.5])
    plot3(rastro_P3(1,:), rastro_P3(2,:), rastro_P3(3,:), 'Color', [0.5 0.5 0.5])
    plot3(rastro_P4(1,:), rastro_P4(2,:), rastro_P4(3,:), 'Color', [0.5 0.5 0.5])
    plot3(rastro_P5(1,:), rastro_P5(2,:), rastro_P5(3,:), 'Color', [0.5 0.5 0.5])
    plot3(rastro_P6(1,:), rastro_P6(2,:), rastro_P6(3,:), 'Color', [0.5 0.5 0.5])

    % Dibujar punto actual en color original

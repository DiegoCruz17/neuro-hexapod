        ...
        for k = k_total
            ...
            for i = 1:6
                ...
                if mod(i,2) == 1  % pata impar
                    if fase > pi
                        color_segmento = 'b';  % arriba
                    else
                        color_segmento = 'r';  % abajo
                    end
                else  % pata par
                    if fase > pi
                        color_segmento = 'r';  % abajo
                ...
                %plot3([P1(1), P2(1)], [P1(2), P2(2)], [P1(3), P2(3)], color_segmento, 'LineWidth', 2);
                %plot3([P2(1), P3(1)], [P2(2), P3(2)], [P2(3), P3(3)], color_segmento, 'LineWidth', 2);
                plot3([P0(1), P1(1)], [P0(2), P1(2)], [P0(3), P1(3)], 'g', 'LineWidth', 2);
